...
![](https://res.cloudinary.com/ulsonhu/image/upload/v1546186422/dv00kppy1_908.jpg)
...
昆曲的发音也很有趣，比如听牡丹亭中“原来姹紫嫣红”中的“姹”，“好天气也”中的“气”，都会发尖音。在昆曲和京剧里，今天普通话读`[ʨ]`、`[ʨʰ]`、`[ɕ]`的字被分为两类，一类仍读`[ʨ]`、`[ʨʰ]`、`[ɕ]`，称为团音，例如“既、气、戏”等字；另一类必须读`[ʦ]`、`[ʦʰ]`、`[s]`（汉语拼音方案作`z`、`c`、`s`），称为尖音，如“祭、砌、细”等字。

其实，昆曲的韵声唱法也是很讲究的。如部分普通话读`geng[kəŋ]`、`keng[kʰəŋ]`、`heng[xəŋ]`的字，昆曲中唱`jing[ʨiəŋ]`、`qing[ʨʰiəŋ]`、`xing[ɕiəŋ]`。 如：更、坑、衡。
